                                        ...
                                        <form id="CreateSize" name="CreateSize" method="post" class="form-horizontal" autocomplete="off">
                                            <div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label class=" form-control-label clsStyle">Coca</label>
                                                </div>
                                                <div class="col-12 col-md-10">
                                                <div class="row">

                                               <div class="col-6 col-md-6">
                                               <input type="text" id="SizeWidth" name="SizeWidth" autocomplete="off"  placeholder="Enter Coca Name..." class="form-control clsStyle">
